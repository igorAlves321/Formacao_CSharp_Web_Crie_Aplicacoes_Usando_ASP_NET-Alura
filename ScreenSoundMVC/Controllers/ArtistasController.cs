...
namespace ScreenSoundMVC.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,FotoPerfil,Bio")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,FotoPerfil,Bio")] Artista artista)
        {
            if (id != artista.Id)
            {
                return NotFound();
